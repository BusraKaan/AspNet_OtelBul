<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="OtelEkle.aspx.cs" Inherits="OtelBulWebProject.OtelEkle" ValidateRequest="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="icerikTasiyici">
        ...
        <div class="satir" style="float: right;">
            <asp:LinkButton runat="server" ID="btn_OtelEkle" Text="Otel Ekle" CssClass="buton" OnClick="btn_OtelEkle_Click"></asp:LinkButton>
        </div>
        <br />
        <br />
        <br />
